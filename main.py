import random
class Human:
    def __init__(self,name="Human",car=None, job=None, home=None,cat=None):
        self.name=name
        self.money=100
        self.gladness=50
        self.satiety=50
...
class Job:
 ...
 class Cat:
     def __init__(self,breed_of_cat):
        self.cat=random.choice(breed(breed_of_cat))
        self.salary=breed_of_cat[self.cat]["salery"]
        self.gladness_less=breed_of_cat[self.cat]["gladness_less"]
